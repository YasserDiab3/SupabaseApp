...
const ActionTrackingRegister = {
    ...
    getTranslations() {
        ...
        const translations = {
            ar: {
                ...
                addActionNew: 'إضافة إجراء جديد',
                serialAuto: '# (تسلسل تلقائي)',
                observationDate: 'تاريخ الملاحظة',
                observationType: 'نوع الملاحظة',
                violationClassification: 'تصنيف المخالفة',
                issueHazard: 'الملاحظة / الخطر',
                correctivePreventiveAction: 'الإجراء التصحيحي أو الوقائي',
                rootCause: 'السبب الجذري',
                department: 'القسم التابع',
                location: 'الموقع بالمصنع',
                riskLevel: 'معدل الخطورة',
                responsibleExecution: 'المسؤول عن التنفيذ',
                targetDate: 'تاريخ التنفيذ المستهدف',
                status: 'الحالة',
                observerName: 'اسم صاحب الملاحظة',
                shift: 'الوردية',
                cancel: 'إلغاء',
                saveChanges: 'حفظ التعديلات',
                addActionBtn: 'إضافة الإجراء',
                selectObservationType: 'اختر نوع الملاحظة',
                selectClassification: 'اختر التصنيف',
                selectObservationFirst: 'اختر نوع الملاحظة أولاً',
                selectClassificationFirst: 'اختر التصنيف أولاً',
                selectRootCause: 'اختر السبب الجذري',
                selectDepartment: 'اختر القسم',
                selectLocation: 'اختر الموقع',
                selectRiskLevel: 'اختر مستوى الخطورة',
                selectResponsible: 'اختر المسؤول',
                enterResponsible: 'أدخل اسم المسؤول',
                selectStatus: 'اختر الحالة',
                enterObserverName: 'اسم صاحب الملاحظة',
                selectShift: 'اختر الوردية',
                issueHazardPlaceholder: 'وصف الملاحظة أو الخطر...',
                actionPlaceholder: 'وصف الإجراء التصحيحي أو الوقائي...',
                autoGenerated: 'سيتم التوليد تلقائياً',
                fillRequiredFields: 'يرجى ملء جميع الحقول المطلوبة',
                actionAddedSuccess: 'تم إضافة الإجراء بنجاح',
                actionUpdatedSuccess: 'تم تحديث الإجراء بنجاح',
                actionDeletedSuccess: 'تم حذف الإجراء بنجاح',
                actionNotFound: 'لم يتم العثور على الإجراء',
                confirmDeleteAction: 'هل أنت متأكد من حذف هذا الإجراء؟',
                errorLoadingActionDetails: 'خطأ في تحميل تفاصيل الإجراء',
                errorValidatingData: 'حدث خطأ في التحقق من البيانات',
                errorDuringSave: 'حدث خطأ أثناء الحفظ',
                errorDuringDelete: 'حدث خطأ أثناء الحذف',
                detailsAction: 'تفاصيل الإجراء',
                print: 'طباعة',
                export: 'تصدير',
                excel: 'Excel',
                pdf: 'PDF',
            ...
            en: {
                ...
                addActionNew: 'Add New Action',
                serialAuto: '# (Auto Sequence)',
                observationDate: 'Observation Date',
                observationType: 'Observation Type',
                violationClassification: 'Violation Classification',
                issueHazard: 'Issue / Hazard',
                correctivePreventiveAction: 'Corrective/Preventive Action',
                rootCause: 'Root Cause',
                department: 'Department',
                location: 'Factory Location',
                riskLevel: 'Risk Level',
                responsibleExecution: 'Responsible for Execution',
                targetDate: 'Target Due Date',
                status: 'Status',
                ...
                selectObservationFirst: 'Select observation type first',
                selectClassificationFirst: 'Select classification first',
                selectRootCause: 'Select Root Cause',
                selectDepartment: 'Select Department',
                selectLocation: 'Select Location',
                selectRiskLevel: 'Select Risk Level',
                selectResponsible: 'Select Responsible',
                enterResponsible: 'Enter responsible name',
                selectStatus: 'Select Status',
                enterObserverName: 'Observer name',
                selectShift: 'Select Shift',
                issueHazardPlaceholder: 'Describe the issue or hazard...',
                actionPlaceholder: 'Describe the corrective or preventive action...',
                autoGenerated: 'Will be auto-generated',
                fillRequiredFields: 'Please fill all required fields',
                actionAddedSuccess: 'Action added successfully',
                actionUpdatedSuccess: 'Action updated successfully',
                actionDeletedSuccess: 'Action deleted successfully',
                actionNotFound: 'Action not found',
                confirmDeleteAction: 'Are you sure you want to delete this action?',
                errorLoadingActionDetails: 'Error loading action details',
                errorValidatingData: 'Error validating data',
                errorDuringSave: 'Error during save',
                errorDuringDelete: 'Error during delete',
                detailsAction: 'Action Details',
                print: 'Print',
                export: 'Export',
                excel: 'Excel',
                pdf: 'PDF',
        ...
        modal.innerHTML = `
            <div class="modal-content" style="max-width: 900px; max-height: 90vh; overflow-y: auto;">
                <div class="modal-header">
                    <h2 class="modal-title">${isEdit ? t('editAction') : t('addActionNew')}</h2>
                ...
                <div class="modal-body">
                    <form id="action-form" class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">${t('serialAuto')}</label>
                                <input type="text" id="action-serial" class="form-input" value="${actionData?.serialNumber || t('autoGenerated')}" disabled>
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">${t('observationDate')} *</label>
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">${t('observationType')} *</label>
                                <select id="action-type-of-issue" required class="form-input">
                                    <option value="">${t('selectObservationType')}</option>
                                    ${typeList.map(t => `<option value="${Utils.escapeHTML(t)}" ${currentType === t ? 'selected' : ''}>${Utils.escapeHTML(t)}</option>`).join('')}
                                </select>
                            </div>
                            <div>
                                <label for="action-classification" class="block text-sm font-semibold text-gray-700 mb-2">${t('violationClassification')} *</label>
                                <select id="action-classification" required class="form-input" ${!currentType ? 'disabled' : ''}>
                                    <option value="">${currentType ? t('selectClassification') : t('selectObservationFirst')}</option>
                            ...
                            <div class="col-span-2">
                                <label for="action-observation-issue-hazard" class="block text-sm font-semibold text-gray-700 mb-2">${t('issueHazard')} *</label>
                                <textarea id="action-observation-issue-hazard" required class="form-input" rows="3" 
                                    placeholder="${t('issueHazardPlaceholder')}">${Utils.escapeHTML(actionData?.observationIssueHazard || '')}</textarea>
                            </div>
                            <div class="col-span-2">
                                <label for="action-corrective-preventive" class="block text-sm font-semibold text-gray-700 mb-2">${t('correctivePreventiveAction')} *</label>
                                <textarea id="action-corrective-preventive" required class="form-input" rows="3" 
                                    placeholder="${t('actionPlaceholder')}">${Utils.escapeHTML(actionData?.correctivePreventiveAction || '')}</textarea>
                            </div>
                            <div>
                                <label for="action-root-cause" class="block text-sm font-semibold text-gray-700 mb-2">${t('rootCause')} *</label>
                                <select id="action-root-cause" required class="form-input" ${!currentClassification ? 'disabled' : ''}>
                                    <option value="">${currentClassification ? t('selectRootCause') : t('selectClassificationFirst')}</option>
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">${t('riskLevel')} *</label>
                                <select id="action-risk-rating" required class="form-input">
                                    <option value="">${t('selectRiskLevel')}</option>
                                    ${riskList.map(r => `<option value="${Utils.escapeHTML(r)}" ${actionData?.riskRating === r ? 'selected' : ''}>${Utils.escapeHTML(r)}</option>`).join('')}
                                </select>
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">${t('responsibleExecution')} *</label>
                                ...
                                ` : `
                                    <input type="text" id="action-responsible" required class="form-input"
                                        value="${Utils.escapeHTML(actionData?.responsible || '')}" placeholder="${t('enterResponsible')}">
                                `}
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">${t('targetDate')} *</label>
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">${t('observerName')} *</label>
                                <input type="text" id="action-observer-name" required class="form-input"
                                    value="${Utils.escapeHTML(actionData?.observerName || '')}" placeholder="${t('enterObserverName')}">
                            </div>
                            <div>
                        ...
                        <div class="flex items-center justify-end gap-4 pt-4 border-t">
                            ...
                            <button type="submit" class="btn-primary">
                                <i class="fas fa-save ml-2"></i>${isEdit ? t('saveChanges') : t('addActionBtn')}
                            </button>
                        </div>
                    </form>
                </div>
    ...
    async handleSubmit(e, actionData, modal) {
        ...
        try {
            ...
            if (!issueDate || !typeOfIssue || !classification || !observationIssueHazard ||
                ...
                Notification.error(t('fillRequiredFields'));
                return;
            }
            ...
            try {
                ...
                if (result.success) {
                    ...
                    Notification.success(`${actionData ? t('actionUpdatedSuccess') : t('actionAddedSuccess')}`);
    ...
    async editEntry(id) {
        ...
        if (!action) {
            Notification.error(t('actionNotFound'));
            return;
        }
    ...
    async deleteEntry(id) {
        ...
        if (typeof window.DataManager !== 'undefined' && window.DataManager.save) {
            ...
            Utils.safeWarn('⚠️ DataManager غير متاح - لم يتم حفظ البيانات');
                ...
                Notification.success(t('actionDeletedSuccess'));
                await this.load();
            } else {
    ...
    async viewAction(id) {
        ...
        try {
            ...
            Utils.safeWarn(t('errorLoadingActionDetails'), error);
        }
            ...
            <div class="modal-content" style="max-width: 95vw; width: 1400px; max-height: 95vh; overflow-y: auto; background: white; border-radius: 8px; box-shadow: 0 4px 20px rgba(0,0,0,0.3);">
                <div class="modal-header" style="padding: 20px; border-bottom: 1px solid #e5e7eb; display: flex; align-items: center; justify-content: space-between; background: #f9fafb;">
                    <h2 class="modal-title" style="font-size: 24px; font-weight: 600; color: #111827; margin: 0;">
                        ...
                        ${t('detailsAction')} #${Utils.escapeHTML(action.serialNumber || action.id || '')}
                    </h2>
                    <div class="flex gap-2">
                        ...
                        <button onclick="if(confirm(t('confirmDeleteAction'))) { ActionTrackingRegister.deleteEntry('${action.id}'); this.closest('.modal-overlay').remove(); }" class="btn-danger btn-sm" title="حذف">
